  ...
  describe Flint::GitHelper do
    describe "generate_commit_message" do
      it "works" do
        ...
        result = Flint::GitHelper.generate_commit_message(values)
        expect(result).to eq("[fastlane] Updated playstore and platform android")
      end
    end
    ...
    describe "#clone" do
      it "skips README file generation if so requested" do
        ...
        result = Flint::GitHelper.clone(git_url, shallow_clone, skip_docs: true)
      ...
      it "clones the repo" do
        ...
        result = Flint::GitHelper.clone(git_url, shallow_clone)
        expect(File.directory?(result)).to eq(true)
      ...
      it "checks out a branch" do
        ...
        result = Flint::GitHelper.clone(git_url, shallow_clone, branch: git_branch)
